...
import { APP_NAME, getExportTemplateDir, getExportVendorDir } from "../../config.js";
import {
...
function generateHtml(sessionData: SessionData, themeName?: string): string {
  ...
  const vendorDir = getExportVendorDir();
  const markedJs = readFileSync(join(vendorDir, "marked.min.js"), "utf-8");
  const hljsJs = readFileSync(join(vendorDir, "highlight.min.js"), "utf-8");
